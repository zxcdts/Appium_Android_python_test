    ...
    def writeCellCurrentTime(self, sheet, coordinate=None,
        ...
        if coordinate is not None:
            try:
                ...
                raise e
        elif None == coordinate and rowNo is not None and colsNo is not None:
            try:
...
if __name__ == '__main__':
    ...
    print type(sheet)
    print "max row number:", pe.getRowsNumber(sheet)  # 获取最大行号
    print "max col number:", pe.getColsNumber(sheet)  # 获取最大列号
